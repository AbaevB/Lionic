...
##### ВАЖНО!
    ...
    **Для стилизации хедера в дальнейшем может пригодиться вот это:**

- К блоку logo применен margin-right: auto.
- Следующий margin-right применен к nav
- К списку навигации применен класс flex.
- Стилизация элементов меню:
    - Применение margin-right (not last child) к элементам списка.
    - Применение стилей к ссылкам.
    
### Стилизация блоков Hero и Services
